...
(function () {
  ...
  var parseOffset = function (element, property) {
    ...
    if (measure === "auto") {
      if (
        property.toLowerCase().indexOf("left") !== -1 ||
        property.toLowerCase().indexOf("right") !== -1
      ) {
        return parseFloat(element.offsetLeft);
      }
      if (
        property.toLowerCase().indexOf("top") !== -1 ||
        property.toLowerCase().indexOf("bottom") !== -1
      ) {
  ...
  Loadgo.options = function (element, useroptions) {
    ...
    if (
      indexOf(validDirections, currentOptions.direction.toLowerCase()) === -1
    ) {
