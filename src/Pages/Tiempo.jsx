    ...
    return (
        <div {...handlers} >
            ...
            <div className="flex flex-col relative z-10 h-screen max-h-screen">
                ...
                >
                    <BackBtn/>
                    <TopTime number={epocaAnterior} isPresentation={year === undefined}
                ...
                <motion.div className="flex flex-col items-center justify-center w-full h-full"
                            ...
                            animate={{opacity : 1, x: direction === "right" ? "-25%" : direction === "left" ? "25%" : 0}}
                            exit={{opacity: 0 ,x: direction === "right" ? "25%" : direction === "left" ? "-25%" : 0}}
