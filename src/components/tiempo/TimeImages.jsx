...
export function TimeImages(props) {
    ...
    return (
        <div
            className="flex w-screen flex-row mx-auto bottom-0 h-full pt-24 gap-x-14 justify-center items-center text-white text-center max-h-full">
            <h1 className="text-white absolute text-xl lg:text-5xl top-14 lg:top-32">{props.data.titulo}</h1>
            {/*flecha izquierda <- */}
            {props.ultimo ?
                <motion.div
                ...
                >
                    <SlArrowLeft
                        className="absolute transform -translate-y-4 lg:-translate-y-7 -translate-x-3 lg:-translate-x-4 text-4xl lg:text-6xl"/>
                </motion.div>
                : null
            }
