...
export function CardText(props) {
  ...
  return (
    <div className="flex flex-row w-screen bottom-0 h-full   justify-center  items-center text-black text-center">
      {/*
...
*/}
      ...
      {/*contenido*/}
      <div className="flex-col w-10/12 lg:w-9/12 text-lg bg-slate-50 bg-opacity-70 rounded-lg p-6 flex mx-auto	 items-center max-h-[16rem] overflow-x-hidden lg:max-h-screen overflow-scroll  lg:overflow-hidden lg:overflow-hidden">
        <h1 className="text-sm lg:text-2xl font-bold mb-2 lg:mb-10 w-full whitespace-pre-line">
