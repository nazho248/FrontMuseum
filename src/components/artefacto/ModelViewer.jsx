...
export function ModelViewer(artefacto) {
  ...
  return (
    <div
      className="flex flex-col w-6/12  align-middle p-5 justify-center items-center"
      style={{ backgroundColor: "#f9e0dc" }}
    >
      <h1
        className="text-xl lg:text-5xl text-center mb-4 lg:mb-12 text-orange-800 font-bold"
        style={{ color: "#A62422" }}
      >
      ...
      <p
        className=" w-10/12 text-base lg:text-2xl mt-3 lg:mt-10 text-center font-light"
        style={{ color: "#A62422" }}
      >
